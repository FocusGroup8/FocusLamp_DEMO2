...
esp_err_t motion_voice_command_execute(const char* command)
{
    ...
    if (strcmp(command, "回去吧") == 0 || strcmp(command, "go_back") == 0) {
    ...
    } else if (strcmp(command, "挥手") == 0 || strcmp(command, "招手") == 0 || strcmp(command, "wave") == 0) {
        return motion_action_execute_async("wave", NULL);
    } else if (strcmp(command, "点头") == 0 || strcmp(command, "nod") == 0) {
        return motion_action_execute_async("nod", NULL);
    } else if (strcmp(command, "摇头") == 0 || strcmp(command, "shake") == 0) {
        return motion_action_execute_async("shake", NULL);
    } else {
