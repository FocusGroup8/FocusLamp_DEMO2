...
static inline esp_err_t task_manager_init(void)
{
    return ESP_ERR_NOT_SUPPORTED;
}
static inline esp_err_t task_manager_deinit(void)
{
    return ESP_ERR_NOT_SUPPORTED;
}
...
static inline esp_err_t task_manager_start_task(int task_id)
{
    (void)task_id;
    return ESP_ERR_NOT_SUPPORTED;
}
static inline esp_err_t task_manager_pause_task(int task_id)
{
    (void)task_id;
    return ESP_ERR_NOT_SUPPORTED;
}
static inline esp_err_t task_manager_resume_task(int task_id)
{
    (void)task_id;
    return ESP_ERR_NOT_SUPPORTED;
}
static inline esp_err_t task_manager_stop_task(int task_id)
{
    (void)task_id;
    return ESP_ERR_NOT_SUPPORTED;
}
static inline esp_err_t task_manager_stop_all_tasks(void)
{
    return ESP_ERR_NOT_SUPPORTED;
}
static inline esp_err_t task_manager_get_task(int task_id, task_info_t *info)
{
    (void)task_id;
    (void)info;
    return ESP_ERR_NOT_SUPPORTED;
}
static inline int task_manager_get_running_count(void)
{
    return 0;
}
static inline bool task_manager_has_running_tasks(void)
{
    return false;
}
static inline esp_err_t task_manager_register_mcp_tools(esp_mcp_t *mcp)
{
    (void)mcp;
    return ESP_ERR_NOT_SUPPORTED;
}
