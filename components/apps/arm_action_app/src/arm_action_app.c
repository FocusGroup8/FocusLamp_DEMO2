...
/* Wave: swing servo 0 back and forth */
...
static const action_sequence_t s_wave_seq = {
    .steps = s_wave_steps, .step_count = 4, .loop_count = 2,
};

/* Nod: tilt servo 1 up and down */
...
static const action_sequence_t s_nod_seq = {
    .steps = s_nod_steps, .step_count = 3, .loop_count = 3,
};

/* Shake: rotate servo 2 left and right */
...
static const action_sequence_t s_shake_seq = {
    .steps = s_shake_steps, .step_count = 4, .loop_count = 3,
};
