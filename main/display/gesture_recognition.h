...
typedef struct {
    ...
    float last_rotation_signed; // Signed rotation of the last detected rotation gesture (radians, +CW / -CCW)
 ...
 */
void gesture_recognition_init(gesture_recognition_t *gesture, void (*callback)(gesture_type_t, void *),
                              void *user_data);
