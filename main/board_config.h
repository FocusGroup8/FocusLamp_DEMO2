 ...
 * @{
 */
#define BOARD_LCD_DPI_CLK_MHZ       20      /*!< DPI pixel clock in MHz. Range: 10-40. Higher = faster refresh but may cause timing issues */
...
#define BOARD_DSI_LANE_BITRATE_MBPS 500     /*!< Per-lane bit rate in Mbps. Range: 80-1500. 500Mbps supports 480x480@60Hz RGB888 */
 ...
 * @{
 */
#define BOARD_DPI_FB_COUNT          1       /*!< Number of frame buffers. 1=single-buffer, 2=double-buffer. Set to 2 for flicker-free animation */
/** @} */
 ...
 * @{
 */
#define APP_GESTURE_SWIPE_THRESHOLD_PX      30      /*!< Min swipe distance in pixels. Range: 10-100. Lower = easier to trigger */
#define APP_GESTURE_LONG_PRESS_THRESHOLD_MS 500     /*!< Min long press duration in ms. Range: 300-2000. Lower = faster detection */
#define APP_GESTURE_PINCH_THRESHOLD         0.2f    /*!< Min scale change for pinch. Range: 0.1-0.5. 0.2 = 20% size change required */
#define APP_GESTURE_ROTATION_THRESHOLD_DEG  20.0f   /*!< Min rotation angle in degrees. Range: 5-45. Lower = more sensitive */
/** @} */
...
#define APP_GESTURE_HISTORY_MAX_LEN     20  /*!< History records per point. Range: 10-50. Higher = longer trajectory tracking */
/** @} */
...
#define APP_GAME_BALL_ROTATION_SPEED    0.05f   /*!< Continuous rotation speed per frame in radians (for visual effect) */
/** @} */
 ...
 * @{
 */
#define APP_GAME_AREA_X_MIN             30      /*!< Left boundary for ball center */
#define APP_GAME_AREA_X_MAX             450     /*!< Right boundary for ball center */
#define APP_GAME_AREA_Y_MIN             190     /*!< Top boundary for ball center */
#define APP_GAME_AREA_Y_MAX             380     /*!< Bottom boundary for ball center */
