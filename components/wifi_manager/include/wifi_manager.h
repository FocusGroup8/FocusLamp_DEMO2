...
static inline esp_err_t wifi_manager_connect(void)
{
    return ESP_ERR_NOT_SUPPORTED;
}
static inline esp_err_t wifi_manager_disconnect(void)
{
    return ESP_ERR_NOT_SUPPORTED;
}
static inline esp_err_t wifi_manager_deinit(void)
{
    return ESP_ERR_NOT_SUPPORTED;
}
static inline bool wifi_manager_is_connected(void)
{
    return false;
}
static inline esp_err_t wifi_manager_scan(wifi_manager_ap_info_t *aps, uint16_t *count)
{
    (void)aps;
    (void)count;
    return ESP_ERR_NOT_SUPPORTED;
}
static inline esp_err_t wifi_manager_get_info(wifi_manager_info_t *info)
{
    (void)info;
    return ESP_ERR_NOT_SUPPORTED;
}
static inline esp_err_t wifi_manager_register_handler(wifi_manager_event_t event, wifi_manager_cb_t cb)
{
    (void)event;
    (void)cb;
    return ESP_ERR_NOT_SUPPORTED;
